...
if(isset($_POST['submit']))
{
	foreach($_POST['attendance_status'] as $id=>$attendance_status)
	{
		...
		$query1="insert into attendance_records(Branch,Date,Roll,Name,Registration,attendance_status) values('IT','$Date','$Roll','$Name','$Registration','$attendance_status')";
...
<div class="panel panel-body">
	...
	<form action="it.php" method="post">
		<table class="table table-striped" cellspacing="50px">
			...
			<th>Attendance</th>
			<?php
			$query="select * from user_login WHERE Branch='IT'";
