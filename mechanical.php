...
if(isset($_POST['submit']))
{
	foreach($_POST['attendance_status'] as $id=>$attendance_status)
	{
		...
		$query1="insert into attendance_records(Branch,Date,Roll,Name,Registration,attendance_status) values('MECHANICAL','$Date','$Roll','$Name','$Registration','$attendance_status')";
